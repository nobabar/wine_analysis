...
```{r}
hist_qual <- ggplot(all_wines) +
               aes_string(x = "quality") +
               geom_histogram(color = "black", fill = "grey", bins = 40L) +
               theme_bw() +
               facet_wrap(~ wine.type, scales = "free")
boxplot_qual <- ggplot(all_wines) +
                  aes_string(x = "quality") +
                  geom_boxplot(color = "black", fill = "grey") +
                  theme_bw() +
                  facet_wrap(~ wine.type, scales = "free")
ggarrange(hist_qual, boxplot_qual, ncol = 2, nrow = 1)

hist_dens <- ggplot(all_wines) +
               aes_string(x = "density") +
               geom_histogram(color = "black", fill = "grey", bins = 40L) +
               theme_bw() +
               facet_wrap(~ wine.type, scales = "free")
boxplot_dens <- ggplot(all_wines) +
                  aes_string(x = "density") +
                  geom_boxplot(color = "black", fill = "grey") +
                  theme_bw() +
                  facet_wrap(~ wine.type, scales = "free")
ggarrange(hist_dens, boxplot_dens, ncol = 2, nrow = 1)

hist_ph <- ggplot(all_wines) +
               aes_string(x = "pH") +
               geom_histogram(color = "black", fill = "grey", bins = 40L) +
               theme_bw() +
               facet_wrap(~ wine.type, scales = "free")
boxplot_ph <- ggplot(all_wines) +
                  aes_string(x = "pH") +
                  geom_boxplot(color = "black", fill = "grey") +
                  theme_bw() +
                  facet_wrap(~ wine.type, scales = "free")
ggarrange(hist_ph, boxplot_ph, ncol = 2, nrow = 1)
```


```{r}

summary_flavor=function(df){
...
print("tous les vins")
summary_flavor(all_wines[-1])
print("vins rouges")
summary_flavor(red_wines)
print("vins blancs")
summary_flavor(white_wines)
```
